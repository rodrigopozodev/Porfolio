  ...
  return (
    <div className="conectar">
      ...
      <div className="linkedin cell">
        <a className="circle" aria-label="Visitar perfil de LinkedIn" href="https://www.linkedin.com/in/rodrigopozosanchez/" target="_blank" rel="noopener noreferrer" data-label="linkedin">
      ...
      <div className="correo cell">
        <button 
          ...
          data-label="correo"
          onClick={() => window.open("https://mail.google.com/mail/?view=cm&to=rodrigopozosanchez@gmail.com", "_blank", "noopener,noreferrer")}
        >
