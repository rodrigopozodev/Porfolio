...
export const Transition: React.FC<TransitionProps> = ({
  ...
  // Escucha un evento global para disparar la transición (por ejemplo, al togglear el tema)
  useEffect(() => {
    const handleThemeToggleTransition = () => {
      // Permite re-disparar la intro cuando se recibe el evento
      setShowIntro(true);
      // Inicia inmediatamente la transición
      startTransition();
    };
