...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="snap-section relative flex items-center justify-center bg-background">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <p className="mb-8 text-pretty text-xl text-muted-foreground md:text-2xl">{t.tagline}</p>
