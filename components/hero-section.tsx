...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="hero-container w-full max-w-screen-2xl mx-auto px-4 min-[700px]:px-6 grid grid-cols-1 lg:grid-cols-3 items-stretch min-[700px]:gap-4 lg:gap-6 pt-8 min-[700px]:pt-12 min-h-60-mobile min-[700px]:min-h-65-mobile">
        <div className="hidden lg:block hero-column p-4 pb-0 h-full pt-8 flex flex-col">
          <TestimonialsSection />
        </div>
        ...
        <div className="origin-top min-[700px]:scale-[0.90] min-[900px]:scale-[0.90] min-[768px]:max-[1023px]:scale-[1.12] lg:scale-[0.95] xl:scale-100 2xl:scale-100">
          <div className="relative w-fit mx-auto min-[768px]:max-[1023px]:-mt-14">
          ...
          <CardFlipFront className="bg-transparent border-none shadow-none p-0">
            <Image
              ...
              width={200}
              height={200}
              className="hidden min-[700px]:block hero-image mx-auto rounded-full shadow-lg xl:mb-14 2xl:mb-16 min-[700px]:scale-[0.80] min-[900px]:scale-[0.9] min-[768px]:max-[1023px]:scale-[1.12] lg:scale-[0.85] xl:scale-[1.35] 2xl:scale-[1.5] object-cover cursor-pointer"
              priority
            />
          </CardFlipFront>
          <CardFlipBack className="bg-transparent border-none shadow-none p-0">
            <div className="relative w-[200px] h-[200px] mx-auto flex flex-col items-center justify-center text-center px-4 xl:mb-14 2xl:mb-16 min-[700px]:scale-[0.80] min-[900px]:scale-[0.9] min-[768px]:max-[1023px]:scale-[1.12] lg:scale-[0.85] xl:scale-[1.35] 2xl:scale-[1.5] min-[700px]:max-[800px]:translate-x-[-8px] min-[700px]:max-[760px]:translate-x-[-12px] min-[700px]:max-[750px]:translate-x-[-14px] min-[700px]:max-[740px]:translate-x-[-16px] min-[700px]:max-[730px]:translate-x-[-18px] min-[700px]:max-[720px]:translate-x-[-20px] min-[700px]:max-[710px]:translate-x-[-22px] translate-y-[10%] xl:translate-y-6 2xl:translate-y-8">
        ...
        <span className="hidden min-[768px]:max-[1023px]:block pointer-events-none absolute -top-2 -left-2">
          <ArrowDownRight className="pointer-arrow arrow-hint-tl text-black dark:text-white" />
        </span>
        <span className="hidden min-[768px]:max-[1023px]:block pointer-events-none absolute -top-2 -right-2">
          <ArrowDownLeft className="pointer-arrow arrow-hint-tr text-black dark:text-white" />
        </span>
        <span className="hidden min-[768px]:max-[1023px]:block pointer-events-none absolute -bottom-3 -left-2">
          <ArrowUpRight className="pointer-arrow arrow-hint-bl text-black dark:text-white" />
        </span>
        <span className="hidden min-[768px]:max-[1023px]:block pointer-events-none absolute -bottom-3 -right-2">
          <ArrowUpLeft className="pointer-arrow arrow-hint-br text-black dark:text-white" />
        </span>
          </div>
        ...
        {(() => {
          ...
          return (
            <h1 className="hero-title mb-6 font-sans font-bold tracking-tight text-foreground text-[2.36rem] min-[700px]:text-[2.36rem] min-[900px]:text-5xl min-[768px]:max-[1023px]:text-[calc(2.36rem*1.12)] min-[768px]:max-[1023px]:mt-10 lg:text-5xl xl:text-6xl 2xl:text-6xl lg:leading-tight">
              <span>{first} </span>
        ...
        {/* Tagline */}
        <p className="mb-4 text-pretty text-xl text-muted-foreground min-[700px]:text-xl min-[768px]:max-[1023px]:text-[1.5rem] min-[768px]:max-[1023px]:mt-4 lg:text-xl xl:text-2xl">
          {t.tagline}
        </p>
        ...
        {/* Conecta conmigo */}
        <div className="mt-2 min-[768px]:max-[1023px]:mt-6 flex flex-col items-center gap-3">
          ...
          <div className="flex items-center justify-center gap-3">
            <a href="https://github.com/rodrigopozodev" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <Button variant="secondary" className="h-12 w-12 rounded-full p-0 bg-transparent text-foreground border border-foreground/20 hover:border-blue-500 hover:text-blue-500 cursor-pointer min-[768px]:max-[1023px]:h-[45px] min-[768px]:max-[1023px]:w-[45px]">
                <Github className="h-5 w-5 min-[768px]:max-[1023px]:h-[18px] min-[768px]:max-[1023px]:w-[18px]" />
              </Button>
            </a>
            <a href="https://www.linkedin.com/in/rodrigopozosanchez/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <Button variant="secondary" className="h-12 w-12 rounded-full p-0 bg-transparent text-foreground border border-foreground/20 hover:border-blue-500 hover:text-blue-500 cursor-pointer min-[768px]:max-[1023px]:h-[45px] min-[768px]:max-[1023px]:w-[45px]">
                <Linkedin className="h-5 w-5 min-[768px]:max-[1023px]:h-[18px] min-[768px]:max-[1023px]:w-[18px]" />
              </Button>
            </a>
            <a
            ...
            >
              <Button variant="secondary" className="h-12 w-12 rounded-full p-0 bg-transparent text-foreground border border-foreground/20 hover:border-blue-500 hover:text-blue-500 cursor-pointer min-[768px]:max-[1023px]:h-[45px] min-[768px]:max-[1023px]:w-[45px]">
                <Mail className="h-5 w-5 min-[768px]:max-[1023px]:h-[18px] min-[768px]:max-[1023px]:w-[18px]" />
              </Button>
            </a>
          </div>
        ...
        <div className="hidden lg:block hero-column h-full pt-8">
          {(() => {
